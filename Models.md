...
| [Qwen 3.6-27B (MLX)](https://huggingface.co/mlx-community/Qwen3.6-27B-4bit) | 4bit | — | [mlx-community/Qwen3.6-27B-4bit](https://huggingface.co/mlx-community/Qwen3.6-27B-4bit) | mlx-openai-server | — | MLX variant for the appliance-style OpenAI-compatible server; use Qwen 3 parsers (`--reasoning-parser qwen3 --tool-call-parser qwen3_coder --enable-auto-tool-choice`) for structured tool calls | 2026-06 |
